...
<body>
    <div class="container mt-5">
        <h2>Form Update Data Matakuliah</h2>
        <hr>
        ...
        <form action="{{ route('matakuliah.update', $matakuliah) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="sks" name="sks" value="{{ old('sks', $matakuliah->sks) }}"
                required>
            </div>
            <div class="mb-3">
                <label for="semester" class="form-label">Semester</label>
                <input type="text" class="form-control" id="semester"
                name="semester" value="{{ old('semester', $matakuliah->semester) }}" required>
            </div>
